...
async def register_user(
    ...
    try:
        ...
        activation_link = f"{BASE_URL}/accounts/activate/?email={new_user.email}&token={activation_token.token}"
        ...
        await db.rollback()
        raise HTTPException(status_code=500, detail="An error occurred during user creation.") from e
    else:
...
async def request_password_reset_token(
    ...
    success_msg = MessageResponseSchema(message="If you are registered, you will receive an email with instructions.")
